...
{
	throw_exception(new_height < MAX_MATRIX_SIZE, COULD_NOT_CREATE_SUCH_A_LARGE_MATRIX);
	throw_exception(new_width < MAX_MATRIX_SIZE, COULD_NOT_CREATE_SUCH_A_LARGE_MATRIX);
	this->clear();
